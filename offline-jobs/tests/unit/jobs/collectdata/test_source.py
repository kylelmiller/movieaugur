...
class MovieLens100kInteractionSourceTests(TestCase):
    class TestMovieLensInteractionSource(MovieLens100kInteractionSource):
        ...
        def __init__(
            self,
            metadata_extractor=TestAbstractMetadataExtractor(),
            ratings_data=None,
            movie_data=None,
            links_data=None,
        ):
    ...
    def test_get_interactions_base_case(self):
        source = MovieLens100kInteractionSourceTests.TestMovieLensInteractionSource()
        self.assertEqual(
            [
...
class TMDBPopularMovieMetadataSourceTests(TestCase):
    pass


class TMDBPopularSeriesMetadataSourceTests(TestCase):
    pass
