...
from jobs.collectdata.collect_data import collect_movielens_100k_data, collect_popular_tmdb_movie_data, collect_popular_tmdb_series_data
...
def create_collect_movielens_data(shared_config: Dict[str, str]) -> DAG:
    ...
    with dag:
        PythonOperator(
            ...
            op_args=[BaseHook.get_connection("http_tmdb_v3").password,
...
collect_movielens100k_data = create_collect_movielens_data(Variable.get("shared_config", deserialize_json=True, default_var={}))
collect_popular_tmdb_series_data = create_collect_popular_tmdb_series_data(Variable.get("shared_config", deserialize_json=True, default_var={}))
collect_popular_tmdb_movie_data = create_collect_popular_tmdb_movie_data(Variable.get("shared_config", deserialize_json=True, default_var={}))